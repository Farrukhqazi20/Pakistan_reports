...
*CON_SIGNATURE_PRYN
keep PREGNANCY_ID CON_YN_DSDECOD SCRNID SCRN_OBSSTDAT AGE_IEORRES PC_IEORRES EXCL_YN_IEORRES ///
 SUBJID KNOWN_DOBYN_SCORRES BRTHDAT ESTIMATED_AGE KNOWN_LMP_SCORRES LMP_SCDAT ///
 ...
 EDD_AVAILYN_SCORRES EDD_SCDAT RESIDE_CATCH_YN_SCORRES DELIVER_CATCH_YN_SCORRES ENR_MOTHER_VILLAGE_SCORRES ///
	...
	*checking duplicates
	 ...
	 *keep PREGNANCY_ID M01_SCRN_OBSSTDAT dup
...
*CASEID
keep  /// 
	  PREGNANCY_ID MARITAL_SCORRES MARITAL_AGE CETHNIC SCHOOL_SCORRES EDU_LEVEL_SCORRES SCHOOL_YRS_SCORRES JOB_SCORRES ///
	 SMOKE_OECOCCUR 
	...
	*rename M02_CASEID CASEID
	rename M02_PREGNANCY_ID PREGNANCY_ID
	********************
	*checking duplicates
     *bysort CASEID:  gen dup = cond(_N==1,0,_n)
	 bysort PREGNANCY_ID:  gen dup = cond(_N==1,0,_n)
...
rename *, upper
*CASEID
keep PREGNANCY_ID PH_VISDAT PH_PREV_RPORRES PH_PREVN_RPORRES ///
...
keep SUBJID PH_BS_RPORRES PH_METH LB_LENGTH_RPORRES BW_RPYN LOSS_ABORT_RPORRES LB_WEIGHT_RPORRES ///
...
rename *, upper
*CASEID 
keep SUBJID OBSSTDAT ANC_VISIT_N ANC_N_1 PATIENT_DSDECOD DTHDAT PRG_DSDECOD ///
	...
	*checking duplicates - this will be subjectid and visit date as we expect duplicates of subjectid
	 ...
	 *keep CASEID visit_date dup
	 keep PREGNANCY_ID visit_date dup
	...
	*reshaping dataset from long to wide
	reshape wide visit_date OBSSTDAT ANC_VISIT_N ANC_N_1 PATIENT_DSDECOD DTHDAT PRG_DSDECOD ///
	PRG_DSSTDAT PRG_DSSTERM PIH_MHOCCUR PIH_MHSTDAT PIH_MHTERM  HIV_MHOCCUR ///
	SYPH_MHOCCUR MALARIA_EVER_MHOCCUR DX_OTHR_PG_MHOCCUR DX_OTHR_LAST_VISIT_MHOCCUR ///
	FOLIC_ACID_CMOCCUR IRON_CMOCCUR CALCIUM_CMOCCUR ///
	MICRONUTRIENT_CMOCCUR ANTHELMINTHIC_CMOCCUR ///
...
rename *, upper
*CASEID
keep PREGNANCY_ID ANT_PEDAT ANT_VISIT_N WEIGHT_PEPERF WEIGHT_PERES HEIGHT_PEPERF HEIGHT_PERES MUAC_PEPERF MUAC_PERES 
*ANT_VISIT_N
...
rename *, upper
*CASEID
keep PREGNANCY_ID US_OHOSTDAT ANC_N_VISIT CRL1_FAORRES ///
...
rename *, upper
*CASEID
keep PREGNANCY_ID VISIT_OBSSTDAT ANC_N_VISIT CBC_SPCPERF CBC_HB_LBORRES	///
...
keep PREGNANCY_ID DIAGNOSTIC_VSDAT ANC_VISIT_N BP1_SYS_VSORRES BP1_DIA_VSORRES ///
...
*M17_CBC_HB_LBORRES* M17_HB_POC_LBORRES*M11_HB_LBORRES M13_POC_HB_VSORRES* M14_HB_POC_LBORRES* M18_CBC_HB_LBORRES* M18_HB_POC_LBORRES*
	...
	M07_CBC_HB_LBORRES1 M07_CBC_HB_LBORRES2 M07_CBC_HB_LBORRES3 M07_CBC_HB_LBORRES4 M07_HB_POC_LBORRES1 M07_HB_POC_LBORRES2 M07_HB_POC_LBORRES3 M07_HB_POC_LBORRES4  ///
	 ///
	M01_GEST_AGE_WKS_SCORRES M01_GEST_AGE_MOS_SCORRES M06_US_GA_WEEKS_AGE1 M06_US_GA_WEEKS_AGE2 M06_US_GA_WEEKS_AGE3 M06_US_GA_WEEKS_AGE4 M06_US_GA_WEEKS_AGE5 M06_US_GA_WEEKS_AGE6 M06_US_GA_WEEKS_AGE7 M06_US_GA_WEEKS_AGE8 M06_US_GA_WEEKS_AGE9  M06_US_GA_DAYS_AGE1 M06_US_GA_DAYS_AGE2 M06_US_GA_DAYS_AGE3 M06_US_GA_DAYS_AGE4 M06_US_GA_DAYS_AGE5 M06_US_GA_DAYS_AGE6 M06_US_GA_DAYS_AGE7 M06_US_GA_DAYS_AGE8 M06_US_GA_DAYS_AGE9  ///
	{
...
*cleaning date variables
	foreach var of varlist M01_LMP_SCDAT M01_EDD_SCDAT {
	replace `var' = "" if(`var' == "-7")
	}
...
*Code for Log File
capture log close
log using "ReMAPP_Data_Cleaning_Log_29_nov_2021_updated.txt", text  replace
...
*Checking Hemoglobin Results - Listing nonplausible results 
	...
	*CBC Hemoglobin Results
	list SUBJID M07_visit_date1 M07_CBC_HB_LBORRES1 if (M07_CBC_HB_LBORRES1<5 | M07_CBC_HB_LBORRES1>=18) & (M07_CBC_HB_LBORRES1 != .)
	list SUBJID M07_visit_date2 M07_CBC_HB_LBORRES2 if (M07_CBC_HB_LBORRES2<5 | M07_CBC_HB_LBORRES2>=18) & (M07_CBC_HB_LBORRES2 != .)
	list SUBJID M07_visit_date3 M07_CBC_HB_LBORRES3 if (M07_CBC_HB_LBORRES3<5 | M07_CBC_HB_LBORRES3>=18) & (M07_CBC_HB_LBORRES3 != .)
	list SUBJID M07_visit_date4 M07_CBC_HB_LBORRES4 if (M07_CBC_HB_LBORRES4<5 | M07_CBC_HB_LBORRES4>=18) & (M07_CBC_HB_LBORRES4 != .)

	
	*Point of Care Hemoglobin Results
	list SUBJID M07_visit_date1 M07_HB_POC_LBORRES1 if (M07_HB_POC_LBORRES1<5 | M07_HB_POC_LBORRES1>=18) & (M07_HB_POC_LBORRES1 != .)
	list SUBJID M07_visit_date2 M07_HB_POC_LBORRES2 if (M07_HB_POC_LBORRES2<5 | M07_HB_POC_LBORRES2>=18) & (M07_HB_POC_LBORRES2 != .)
	list SUBJID M07_visit_date3 M07_HB_POC_LBORRES3 if (M07_HB_POC_LBORRES3<5 | M07_HB_POC_LBORRES3>=18) & (M07_HB_POC_LBORRES3 != .)
	list SUBJID M07_visit_date4 M07_HB_POC_LBORRES4 if (M07_HB_POC_LBORRES4<5 | M07_HB_POC_LBORRES4>=18) & (M07_HB_POC_LBORRES4 != .)
...
*Checking Gestational Age 
	...
	*Participants without any Gestational Estimates 
	list SUBJID if M01_GEST_AGE_WKS_SCORRES==. & M01_GEST_AGE_MOS_SCORRES==. & M06_US_GA_DAYS_AGE1==. & M06_US_GA_DAYS_AGE2==. & M06_US_GA_DAYS_AGE3==. & M06_US_GA_DAYS_AGE4==. & M06_US_GA_DAYS_AGE5==. & M06_US_GA_DAYS_AGE6==. & M06_US_GA_DAYS_AGE7==. & M06_US_GA_DAYS_AGE8==. & M06_US_GA_DAYS_AGE9==.  
	
	*Gestational Age out of range
	list SUBJID M01_GEST_AGE_WKS_SCORRES if (M01_GEST_AGE_WKS_SCORRES<4 | M01_GEST_AGE_WKS_SCORRES>=38) & M01_GEST_AGE_WKS_SCORRES!= .  //should this be less when should they be recruited?
	list SUBJID M01_GEST_AGE_MOS_SCORRES if (M01_GEST_AGE_MOS_SCORRES<1 | M01_GEST_AGE_MOS_SCORRES>=10) & M01_GEST_AGE_MOS_SCORRES!= .
	
	*Missing EDD or date of last period 
	list SUBJID if M01_LMP_SCDAT==. | M01_EDD_SCDAT==.
...
translate "ReMAPP_Data_Cleaning_Log_29_nov_2021_updated.txt" "ReMAPP_Data_Cleaning_Log_29_nov_2021_updated.pdf"
