 ...
 EDD_AVAILYN_SCORRES EDD_SCDAT RESIDE_CATCH_YN_SCORRES DELIVER_CATCH_YN_SCORRES ENR_MOTHER_VILLAGE_SCORRES ///
	...
	*checking duplicates
	 ...
	 *keep CASEID M01_SCRN_OBSSTDAT dup
	 ...
	 export excel using "ReMAPP_Duplicates_18_nov_2021.xlsx" , sheet("MNH01") firstrow(variables) sheetmodify
	...
	*generating flag variable for MNH01 
	 ...
	 ******creating gestational age in Months
	 replace M01_GEST_AGE_WKS_SCORRES= round(M01_GEST_AGE_WKS_SCORRES)
	 gen M01_GEST_AGE_MOS_SCORRES = M01_GEST_AGE_WKS_SCORRES/4 
	 replace M01_GEST_AGE_MOS_SCORRES= . if M01_GEST_AGE_MOS_SCORRES < 0
	 replace M01_GEST_AGE_MOS_SCORRES= round(M01_GEST_AGE_MOS_SCORRES)
	 lab var M01_GEST_AGE_MOS_SCORRES "Estimated GA in months"
...
rename *, upper
*CASEID
keep SUBJID PH_VISDAT PH_PREV_RPORRES PH_PREVN_RPORRES ///
...
replace M07_CBC_HB_LBORRES2= . if (M07_CBC_HB_LBORRES2== 999)
lab def M07_CBC_HB_LBORRES2 999 "Negative"
