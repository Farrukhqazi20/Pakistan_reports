...
replace GEST_AGE_WKS_SCORRES= round(GEST_AGE_WKS_SCORRES)
	...
	*checking duplicates
	 ...
	 *keep CASEID M01_SCRN_OBSSTDAT dup
	 ...
	 export excel using "ReMAPP_Duplicates_14_dec_2021.xlsx" , sheet("MNH01") firstrow(variables) sheetmodify
...
keep SUBJID PREGNANCY_ID PH_VISDAT PH_PREV_RPORRES PH_PREVN_RPORRES ///
	...
	*checking duplicates
	 ...
	 *keep CASEID dup
	 keep SUBJID dup
	 export excel using "ReMAPP_Duplicates_14_dec_2021.xlsx"  , sheet("MNH03a") firstrow(variables) sheetmodify
	 restore // restoring old dataset
	**********************
...
keep SUBJID PREGNANCY_ID PH_BS_RPORRES PH_METH LB_LENGTH_RPORRES BW_RPYN LOSS_ABORT_RPORRES LB_WEIGHT_RPORRES ///
	...
	*checking duplicates
	 ...
	 *keep CASEID dup
	 keep SUBJID dup
	 export excel using "ReMAPP_Duplicates_14_dec_2021.xlsx"  , sheet("MNH03b") firstrow(variables) sheetmodify
	 restore // restoring old dataset
	**********************
 ...
 *Labeling Variables
	...
	*checking duplicates - this will be subjectid and visit date as we expect duplicates of subjectid
	 ...
	 *keep CASEID visit_date dup
	 keep SUBJID visit_date dup
	 export excel using "ReMAPP_Duplicates_14_dec_2021.xlsx"  , sheet("MNH06") firstrow(variables) sheetmodify
	 restore // restoring old dataset
	********************** 
...
*Code for Log File
capture log close
log using "ReMAPP_Data_Cleaning_Log_Part1_14_dec_2021_SUBJID.txt", text  replace
...
*Checking Gestational Age 
	...
	*Last Period Date not feasible 
	list SUBJID M01_LMP_SCDAT if M01_LMP_SCDAT > td(14dec2021) & M01_LMP_SCDAT!=.
	
	*EDD Date not feasible 
	list SUBJID M01_EDD_SCDAT if M01_EDD_SCDAT > td(14dec2021)+270 & M01_EDD_SCDAT!= .
...
*translate "ReMAPP_Data_Cleaning_Log_14_dec_2021_SUBJID.txt" "ReMAPP_Data_Cleaning_Log_29_nov_2021_updated.pdf"
